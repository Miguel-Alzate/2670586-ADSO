...
public class TablaBasica extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if( documento.equals("") || nombres.equals("") || apellidos.equals("") || telefono.equals("") || correo.equals("") ){
            Alerta ventana_campos = new Alerta("Todos los campos son Obligatorios.");  
        }else{
            ...
            for (int i = 0; i < listaPersonas.length; i++) {
                if (listaPersonas[i] != null) { 
                    ...
                    if (correo.equals(listaPersonas[i].getCorreo())) {
            ...
            if (documentoDuplicado) {
                Alerta ventana_documento = new Alerta("Ya hay una persona con este documento"); 
            } else if (correoDuplicado) {
                Alerta ventana_correo = new Alerta("Ya hay una persona con este correo"); 
            }else{

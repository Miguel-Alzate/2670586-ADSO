public class Principal{
	public static void main(String[] args) {
		...
		Productos listaProductos [] = new Productos [100];
		...
		listaProductos[0] = new Productos("1010", "Leche", 3800);
		listaProductos[1] = new Productos("1011", "Carne 1Kg", 25600);
		listaProductos[2] = new Productos("1012", "Carne 1Lb", 12800);
		listaProductos[3] = new Productos("1013", "Jabon Barra", 2500);
		listaProductos[4] = new Productos("1014", "Detergente 1Kg", 15000);

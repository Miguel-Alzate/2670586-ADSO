...
public class AlertaCrear extends javax.swing.JFrame {

    String texto;
   
    public AlertaCrear(String texto) {
        this.texto = texto;
        initComponents();
    ...
    public void initAlternComponents(){
        ...
        setIconImage( getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_bien.png") ) );
        
        Image img_warning = getToolkit().createImage( ClassLoader.getSystemResource("imagenes/icono_bien.png") );
    ...
    private void initComponents() {
        ...
        btnCerrar.setBackground(new java.awt.Color(51, 255, 0));
